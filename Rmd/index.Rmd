...
- [ドイツのPyConでR（とPython）の話をしてきた話](ドイツのPyConでR（とPython）の話をしてきた話_TokyoR_82_20191026.pdf) (Tokyo.R, 26th October 2019)

### Python
- データサイエンスのためのリーダブルコードのススメ (PyCon mini Hiroshima, 10th October 2020)
